package org.jhbf.tetris.tetrisShape 
{
	 ...
	 * @author JHBF
	 */
	public class Shape_4 implements IShape 
	{
		private const ARR_SHAPE_1:Array = [new Point(4, 0), new Point(4, 1), new Point(5, 0), new Point(5, 1)]; /* of Point */
		private const ARR_SHAPE_2:Array = [new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0)]; /* of Point */
		private var _numStates:int = 2;
		private var _currentState:int = 1;
		private var _id:int = 4;
		
		public function Shape_4() 
		{
